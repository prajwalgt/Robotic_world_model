...
class UnitreeG1FlatEnv(BaseEnv):
    ...
    # Joint indices within the 37-DOF joint vector, matching the USD joint ordering from Isaac Lab.
    # Verified from Isaac-Velocity-Flat-G1-v0 (G1_MINIMAL_CFG / g1_minimal.usd):
    #   0:  left_hip_pitch       1:  right_hip_pitch      2:  torso
    #   3:  left_hip_roll        4:  right_hip_roll        5:  left_shoulder_pitch
    #   6:  right_shoulder_pitch 7:  left_hip_yaw          8:  right_hip_yaw
    #   9:  left_shoulder_roll   10: right_shoulder_roll   11: left_knee
    #   12: right_knee           13: left_shoulder_yaw     14: right_shoulder_yaw
    #   15: left_ankle_pitch     16: right_ankle_pitch     17: left_elbow_pitch
    #   18: right_elbow_pitch    19: left_ankle_roll       20: right_ankle_roll
    #   21: left_elbow_roll      22: right_elbow_roll      23-36: finger joints
    HIP_KNEE_INDICES = [0, 1, 3, 4, 7, 8, 11, 12]  # hip_pitch(0,1) + hip_roll(3,4) + hip_yaw(7,8) + knee(11,12)
    HIP_YAW_ROLL_INDICES = [3, 4, 7, 8]  # hip_roll(3,4) + hip_yaw(7,8)
    ARM_INDICES = [5, 6, 9, 10, 13, 14, 17, 18, 21, 22]  # shoulder_pitch/roll/yaw + elbow_pitch/roll
    FINGER_INDICES = list(range(23, 37))  # 14 finger joints
    TORSO_INDICES = [2]  # torso_joint
